...
export const getServerSideProps = wrapper.getServerSideProps(
  (store) =>
    (async (context) => {
      ...
      const showsList = await store.dispatch(
        showsApi.endpoints.getShowsList.initiate({
      ...
      const showsNumber = await store.dispatch(
        showsApi.endpoints.getShowsNumber.initiate({
      ...
      const response = details
        ? await store.dispatch(
            showsApi.endpoints.getShowData.initiate({
